...
class SimpleCaptcha {
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        for ($i=0; $i<$length; $i++) {
            ...
            if ($this->shadowColor) {
			$coords = 	imagestring($this->im, $fontsize, $x+$this->scale, $y+$this->scale, $letter, $this->GdFgColor);
               // $coords = imagettftext($this->im, $fontsize, $degree,
                    //$x+$this->scale, $y+$this->scale,
                  //  $this->GdShadowColor, $fontfile, $letter);
            }
			
			$coords = 	imagestring($this->im, $fontsize, $x, $y, $letter, $this->GdFgColor);
