        ...
        public function editpropertyAction()
        {
            ...
            switch ($mySession->step)
            {
                ...
                case '6': $this->view->step = '7';
                    ...
                    $this->view->is_insured = $rentalQues[0]['is_insured'];
...
//            prd($metaArr[0]['meta_title']);
            ...
            $this->view->headTitle($Description)->offsetUnset(0);
        ...
        public function displaybookingAction()
        {
            ...
            $pptyArr = $db->runQuery("select * from " . PROPERTY . " 
							  ...
							  left join " . SUB_AREA . " on " . SUB_AREA . ".sub_area_id = " . PROPERTY . ".sub_area_id
							  left join " . LOCAL_AREA . " on " . LOCAL_AREA . ".local_area_id = " . PROPERTY . ".local_area_id
							  where " . PROPERTY . ".id = '" . $bookingyArr[0]['pid'] . "'");
        ...
        public function bookingoAction()
        {
            global $mySession;
            $db = new Db();
            $bookingyArr = $db->runQuery("select *, " . PROPERTY . ".id from " . BOOKING . " 
									 inner join " . PROPERTY . " on " . PROPERTY . ".Id=" . BOOKING . ".property_id  
        ...
        public function deletenewsAction()
        {
            ...
            if ($newsId != "")
            {
                ...
                $arr = explode(',',$updateQuery[0]['black_viewers']);
                $arr[] = $mySession->LoggedUserId;
                $data_update['black_viewers'] = implode(',',$arr);
        ...
        public function doajaxfileuploadAction()
        {
            ...
            else
            {
                ...
                if (in_array($extnsn[count($extnsn) - 1], $allowed_extnsn))
                {
                    ...
                    //$watermarkAndUpload = $this->addwatermark($_FILES['photo_res']['tmp_name'], $_FILES['photo_res']['name'], $_FILES['photo_res']['tmp_name'], SITE_ROOT . "ankit_ups/" . $newfilename, $font_file_ttf, "dealatrip.co.uk");
                    ...
                    else
                    {
                        ...
                        $newfilename = 'watermarked_' . $newfilename;
                        //$files = glob(SITE_ROOT . "ankit_ups/*");
        ...
        function watermark_text($oldimage_name, $new_image_name)
        {
            ...
            $water_mark_text_2 = "dealatrip.co.uk";
            $angle = 0;
            //$width = $height = 300;
            ...
            $dimensions = imagettfbbox($font_size, $angle, $font_path, $water_mark_text_2);
            ...
            $check = imagettftext($image, $font_size, $angle, $x, 20, $blue, $font_path, $water_mark_text_2);
            //prd($check);
...
//            $this->view->propertyCodesArr = $propert_codes_arr;
        ...
        function uptodateAction(){
            ...
            if($type == 'edit')
                $this->_redirect("myaccount/editproperty/ppty/".$pptyId."/step/6");
            else
                $this->_redirect ("myaccount/addproperty");
