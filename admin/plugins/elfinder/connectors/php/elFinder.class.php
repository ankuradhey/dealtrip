...
class elFinder {
	...
	protected $_options = array(
		...
		'URL'          => 'http://www.dealatrip.co.uk/uploads/',           // root directory URL
	...
	$this->_options['root'] = dirname(dirname(dirname(dirname(dirname(dirname(dirname(__FILE__)))))))."/uploads";
