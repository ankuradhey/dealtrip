...
function () {
    ...
    d = this, a = jQuery, a.fn.extend({
        ...
        return f(e, b), e.prototype.setup = function () {
			...
			//console.log( this.container.height()=this.container.height()-20);
			
			/*sedit*/ return false;
			
            /*sremove*/ /*return this.is_multiple || (this.selected_item.addClass("chzn-single-with-drop"), this.result_single_selected && this.result_do_highlight(this.result_single_selected)), a = this.is_multiple ? this.container.height() : this.container.height() - 1, this.dropdown.css({
                top: a + "px",
                left: 0
